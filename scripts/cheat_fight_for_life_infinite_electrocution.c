...
//__BIGPEMU_META_DESC__    "Infinite health with infinite loop possibility, in Fight For Life."
...
void bigp_init()
{
   ...
   sHealthSettingHandle = bigpemu_register_setting_bool(catHandle, "Infinite Health Infinite Electrocution", 1);
