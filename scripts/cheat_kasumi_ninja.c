...
#define KASUMI_NINJA_HEALTH_ADDR    0x000060B6
#define KASUMI_NINJA_HEALTH_VALUE   0xFFFF
...
static uint32_t on_emu_frame(const int eventHandle, void* pEventData)
{
   if (sMcFlags & skMcFlag_Loaded)
   {
      ...
      {
         bigpemu_jag_write16(KASUMI_NINJA_HEALTH_ADDR, KASUMI_NINJA_HEALTH_VALUE);
      }
   }
   return 0;
}
